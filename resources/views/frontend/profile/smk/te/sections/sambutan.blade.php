        ...
        <div class="grid md:grid-cols-[340px_1fr] gap-16 items-center">
            ...
            <div>
                ...
                <p class="text-gray-600 leading-relaxed mb-6">
                    ...
                    Jurusan ini membekali siswa dengan pengetahuan dan keterampilan di bidang elektronika, 
                    sistem kontrol, dan teknologi berbasis mikrokontroler yang terus berkembang mengikuti kemajuan industri.
                ...
                <p class="text-gray-600 leading-relaxed">
                    ...
                    Melalui pembelajaran teori dan praktik, siswa dilatih untuk memahami rangkaian elektronika,
                    pemrograman mikrokontroler, sistem embedded, serta pengembangan perangkat berbasis Internet of Things (IoT). 
                    Kami berkomitmen mencetak lulusan yang kompeten, inovatif, dan siap menghadapi dunia kerja
